 ...
 late String formattedDate = addedDateString == 'loading'
  ...
  Future<void> _getReports() async {
    ...
    if (response.statusCode == 200) {
      ...
      final _filteredReport = _fetchedReports.cast<Map<String, dynamic>>().firstWhere(
      ...
      throw Exception(FlutterI18n.translate(context, 'Failed to fetch Reports'));
    }
  }
  ...
  Widget build(BuildContext context) {
            ...
            IconButton(
              ...
              onPressed: () {
                List<OptionMenuItem> menuItems = [
                  OptionMenuItem(
                    title: FlutterI18n.translate(context, 'Edit Report'),
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => UpdateReport(reportId: _reportdetails!['ID']),
                        ),
                      );
                    },
                  ...
                  OptionMenuItem(
                    title: FlutterI18n.translate(context, 'Cancel Report'),
                    onTap: () {
                ...
                child: InkWell(
                  onTap: () {
                    if (_reportdetails != null) {
                      double latitude = _reportdetails!['alt'] != null
                          ? double.parse(_reportdetails!['alt']!.toString())
                          : 0.0;
                      double longitude = _reportdetails!['lag'] != null
                          ? double.parse(_reportdetails!['lag']!.toString())
                          : 0.0;
                  ...
                  child: _reportdetails != null
                      ? Expanded(
                    child: ShowLocations(
                      latitude: _reportdetails!['alt'] != null
                          ? double.parse(_reportdetails!['alt']!.toString())
                          : 0.0,
                      longitude: _reportdetails!['lag'] != null
                          ? double.parse(_reportdetails!['lag']!.toString())
                          : 0.0,
    ...
    value: FlutterI18n.translate(context, formattedDate),
    ),
              ColumnItem(
                textDirection: Directionality.of(context),

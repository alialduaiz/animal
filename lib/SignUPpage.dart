...
class _SignupPageState extends State<SignupPage> {
  ...
  Future<bool> signUpUser() async {
    try {
      final response = await http.post(Uri.parse('$GServer/register'), body: {
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                ...
                content: Text(FlutterI18n.translate(context,
                    'These data are wrong email or National ID or phone number heave been already registered')),
                actions: <Widget>[
                  TextButton(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        hintText:
                            '${FlutterI18n.translate(context, 'Full Name')}',
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText:
                            '${FlutterI18n.translate(context, 'Email Address')}',
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText:
                            '${FlutterI18n.translate(context, 'National ID')}',
                              ...
                              Expanded(
                                ...
                                child: Container(
                                  decoration: BoxDecoration(
                                      ...
                                      border: Border.all(
                                          width: 1, color: Color(0xFF087474))),
                                  child: Padding(
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText:
                            '${FlutterI18n.translate(context, 'add your phone number(0530458777)')}',
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText:
                            '${FlutterI18n.translate(context, 'Birthdate')}',
                            ...
                            showDialog(
                              ...
                              builder: (BuildContext context) {
                                return AlertDialog(
                                  ...
                                  content: Text(
                                      '${FlutterI18n.translate(context, 'You should be older than 14 to sign up')}'),
                                  actions: <Widget>[
                                    TextButton(
                                      child: Text(
                            ...
                            if (flag) {
                              showDialog(
                                  ...
                                  builder: (BuildContext context) {
                                    return AlertDialog(
                                      ...
                                      content: Text(
                                          '${FlutterI18n.translate(context, 'Successful Sign up')}'),
                                      actions: <Widget>[
                                        TextButton(
                                          child: Text(
                                              '${FlutterI18n.translate(context, 'Close')}'),
                              ...
                              AlertDialog(
                                title: Text(
                                    '${FlutterI18n.translate(context, 'Error')}'),
                                content: Text(
                                    '${FlutterI18n.translate(context, 'Signup failed plesue make sure of your info or try again later')}'),
                                actions: <Widget>[
                                  TextButton(
                                    child: Text(
                                        '${FlutterI18n.translate(context, 'Close')}'),
                            ...
                            builder: (BuildContext context) {
                              return AlertDialog(
                                title: Text(
                                    '${FlutterI18n.translate(context, 'Error')}'),
                                content: Text(
                                    '${FlutterI18n.translate(context, 'Please complete all fields correctly')}'),
                                actions: <Widget>[
                                  TextButton(
                                    child: Text(
                                        '${FlutterI18n.translate(context, 'Close')}'),
      ...
      // bottomNavigationBar: LanguageSelectionBottomBar(setLocale),
    );
  }
}
